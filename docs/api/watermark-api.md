...
Draw text or image watermarks onto a canvas. Prefer `options.watermark` on [`compress`](/api/compress) for end-to-end encoding.
...
- Guide: [Watermark](/guide/features/watermark)
