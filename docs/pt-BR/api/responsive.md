...
Gera saídas orientadas a srcset para entrega responsiva.
...
Also available as `generateResponsive: true` on [`CompressionOptions`](/pt-BR/api/types#compressionoptions) for compress-time multi-size generation where supported.
