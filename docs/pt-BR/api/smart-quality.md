...
Análise de conteúdo usada com `enableSmartQuality: true`.
...
- [analyzeImage](/pt-BR/api/analyze-image) — richer recommendations
- Guide: [Smart Quality](/pt-BR/guide/features/smart-quality)
