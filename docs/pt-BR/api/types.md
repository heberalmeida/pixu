...
| `filters` | filter list | — | See [Filters](/pt-BR/api/filters) |
...
See [compressBatch](/pt-BR/api/compress-batch).
...
See [compressStream](/pt-BR/api/compress-stream).
